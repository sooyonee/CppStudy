// A const function formal parameter cannot be modified inside the function.
// A const function parameter can receive both const and non-const argument. 
// On the other hand, a non-const function reference/pointer parameter can only receive non-const argument.
#include <iostream>
using namespace std;
